...
namespace touchBoard {
    ...
    export function initTouchController(): void {
        ...
        makerbit.background.schedule(detectAndNotifyTouchEvents, makerbit.background.Thread.UserCallback, makerbit.background.Mode.Repeat, TOUCH_STATUS_PAUSE_BETWEEN_READ);
    }
     ...
     */
    //% blockId=touchboard_touch_sensor_index
